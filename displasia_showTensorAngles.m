...
legend('streamline segment','origin',...
        ['1: $\alpha$='    num2str(alphas(1),'%1.0f') '; $\beta$=' num2str(betas(1),'%1.0f') ' deg; abs(dot)=' num2str(dots(1),'%1.2f')],...
        ['2: $\alpha$='    num2str(alphas(2),'%1.0f') '; $\beta$=' num2str(betas(2),'%1.0f') ' deg; abs(dot)=' num2str(dots(2),'%1.2f')],...
        ['3: $\alpha$='    num2str(alphas(3),'%1.0f') '; $\beta$=' num2str(betas(3),'%1.0f') ' deg; abs(dot)=' num2str(dots(3),'%1.2f')],...
        ['parallel: '      num2str(indexpar)],...
        ['perpendicular: ' num2str(indexperp)],...
